...
classnames = [
    "Dormitorio", "Costa", "Bosque", "Autopista", "Zona Industrial", "Interior ciudad",
    "Cocina", "Sala de estar", "Montaña", "Oficina", "Campo abierto", "Tienda",
    "Calle", "Suburbio", "Edificio alto"
]

class_emojis = {
    "Dormitorio": "🛏️", "Costa": "🏖️", "Bosque": "🌳", "Autopista": "🛣️",
    "Zona Industrial": "🏭", "Interior ciudad": "🏙️", "Cocina": "🍳", "Sala de estar": "🛋️",
    "Montaña": "⛰️", "Oficina": "💼", "Campo abierto": "🌾", "Tienda": "🛒",
    "Calle": "🚦", "Suburbio": "🏘️", "Edificio alto": "🏢"
}
    ...
    if image_file is not None:
        with st.spinner("🔍 Analizando imagen..."):
            ...
            transform_pipeline = transforms.Compose([
                transforms.Grayscale(num_output_channels=3),  # Convertir a blanco y negro pero mantener 3 canales
